...
ApplicationWindow {
    ...
    property string currentGear: "P"  // NEW: Track selected gear
    ...
    Shortcut {
       ...
       // NEW: Gear switching shortcuts
       Shortcut {
           sequence: "P"
           onActivated: currentGear = "P"
       }
       Shortcut {
           sequence: "R"
           onActivated: currentGear = "R"
       }
       Shortcut {
           sequence: "N"
           onActivated: currentGear = "N"
       }
       Shortcut {
           sequence: "D"
           onActivated: currentGear = "D"
       }
        ...
        */
        ...
        RowLayout {
                   ...
                   Label {
                       ...
                       font.capitalization: Font.AllUppercase
                       color: {
                           if (currentGear === "R") return "yellow"
                           else if (currentGear === "D") return "#FF453A"
                           else return "#32D74B"
                       }
                   }
                   ...
                   Label {
                       ...
                       font.bold: Font.Normal
                       font.capitalization: Font.AllUppercase
                       opacity: currentGear === "P" ? 1.0 : 0.2
                       color: "#FFFFFF"
                       MouseArea {
                           anchors.fill: parent
                           onClicked: currentGear = "P"
                       }
                   }
                   ...
                   Label {
                       ...
                       font.bold: Font.Normal
                       font.capitalization: Font.AllUppercase
                       opacity: currentGear === "R" ? 1.0 : 0.2
                       color: "#FFFFFF"
                       MouseArea {
                           anchors.fill: parent
                           onClicked: currentGear = "R"
                       }
                   }
                   ...
                   Label {
                       ...
                       font.bold: Font.Normal
                       font.capitalization: Font.AllUppercase
                       opacity: currentGear === "N" ? 1.0 : 0.2
                       color: "#FFFFFF"
                       MouseArea {
                           anchors.fill: parent
                           onClicked: currentGear = "N"
                       }
                   }
                   ...
                   Label {
                       ...
                       font.bold: Font.Normal
                       font.capitalization: Font.AllUppercase
                       opacity: currentGear === "D" ? 1.0 : 0.2
                       color: "#FFFFFF"
                       MouseArea {
                           anchors.fill: parent
                           onClicked: currentGear = "D"
                       }
                   }
               }
